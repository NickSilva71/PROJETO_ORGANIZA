...
export default function CriarNotificacao({ onSubmit, notificacoes = [] }) {
  ...
  const formatarData = (data_limite) => {
    ...
    const dia = String(dataObjeto.getDate() + 1).padStart(2, "0"); // Corrigindo para considerar o fuso horário
